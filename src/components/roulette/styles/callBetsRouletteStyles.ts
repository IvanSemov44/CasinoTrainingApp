 ...
 */
export const getCallBetsRouletteStyles = (cellSize: number) => StyleSheet.create({
  // Container styles
  container: {
...
export const getCallBetsZeroColumnStyles = (cellSize: number) => StyleSheet.create({
  zeroColumn: {
    justifyContent: 'center',
    position: 'relative',
    marginLeft: 0,
...
export const getCallBetsOutsideBetsStyles = (cellSize: number) => StyleSheet.create({
  outsideBetsRow: {
    flexDirection: 'row',
    backgroundColor: '#0d3320',
    overflow: 'visible',
...
export const getCallBetsColumnBetsStyles = (cellSize: number) => StyleSheet.create({
  columnBetsContainer: {
