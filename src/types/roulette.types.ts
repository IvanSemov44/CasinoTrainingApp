...
export enum ExerciseType {
  ...
  CASH_HANDLING_TEN_DOLLAR = 'CASH_HANDLING_TEN_DOLLAR',
  CASH_HANDLING_TWENTY_FIVE_DOLLAR = 'CASH_HANDLING_TWENTY_FIVE_DOLLAR',
  CASH_HANDLING_ONE_HUNDRED_DOLLAR = 'CASH_HANDLING_ONE_HUNDRED_DOLLAR',
