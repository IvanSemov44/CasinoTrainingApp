...
describe('PositionMenuScreen', () => {
  ...
  describe('Rendering', () => {
    it('renders without crashing', () => {
      const { toJSON } = renderWithTheme(<PositionMenuScreen />);
      expect(toJSON()).toBeTruthy();
    });

    it('renders the title', () => {
      const { getByText } = renderWithTheme(<PositionMenuScreen />);
  ...
  describe('Wheel Order Reference', () => {
    ...
    it('renders wheel numbers', () => {
      const { getByText, getAllByText } = renderWithTheme(<PositionMenuScreen />);
