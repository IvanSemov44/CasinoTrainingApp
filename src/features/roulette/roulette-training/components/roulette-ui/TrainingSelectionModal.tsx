...
import {
  ...
  getTrainingBetTypes,
  getTrainingScreen,
} from '@features/roulette/roulette-training/utils/trainingSelection.utils';
import {
  buildTrainingSelectionNumberInput,
  buildTrainingSelectionSteps,
  buildTrainingSelectionSummary,
} from '@features/roulette/roulette-training/utils/trainingSelectionModalConfig.utils';
