...
describe('RacetrackOverlays', () => {
  ...
  describe('rendering', () => {
    it('should render without crashing', () => {
      const { toJSON } = render(<RacetrackOverlays width={350} height={140} />);
      expect(toJSON()).toBeNull();
    });

    it('should render section buttons when onSectionPress is provided', () => {
      const { toJSON } = render(
        <RacetrackOverlays width={350} height={140} onSectionPress={mockOnSectionPress} />
      );
    ...
    it('should render number buttons when onNumberPress is provided', () => {
      const { toJSON } = render(
        <RacetrackOverlays width={350} height={140} onNumberPress={mockOnNumberPress} />
      );
      expect(toJSON()).toBeTruthy();
    });
  ...
  describe('section press handlers', () => {
    ...
    it('should call onSectionPress with orphelins', () => {
      render(<RacetrackOverlays width={350} height={140} onSectionPress={mockOnSectionPress} />);
  ...
  describe('coordinate transformation', () => {
    it('should handle different widths', () => {
      const { toJSON: toJSON1 } = render(<RacetrackOverlays width={200} height={80} />);
      const { toJSON: toJSON2 } = render(<RacetrackOverlays width={500} height={200} />);
      expect(toJSON1()).toBeNull();
      expect(toJSON2()).toBeNull();
    });

    it('should handle different heights', () => {
      const { toJSON: toJSON1 } = render(<RacetrackOverlays width={350} height={100} />);
      const { toJSON: toJSON2 } = render(<RacetrackOverlays width={350} height={200} />);
      expect(toJSON1()).toBeNull();
      expect(toJSON2()).toBeNull();
    });
