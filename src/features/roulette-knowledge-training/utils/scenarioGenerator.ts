...
const ANNOUNCED_COMPOSITION_QUESTIONS: StaticQuestion[] = [
  {
...
interface AnnouncedMixedQuestion { q: string; correct: string; options: string[]; explanation: string; winningNumber: number }

const ANNOUNCED_MIXED_QUESTIONS: AnnouncedMixedQuestion[] = [
  {
    winningNumber: 26,
...
const BET_LIMITS_QUESTIONS: StaticQuestion[] = [
  {
