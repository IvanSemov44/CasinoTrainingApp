...
describe('CashDisplay', () => {
  it('should render title', () => {
    const { getByText } = renderWithTheme(<CashDisplay amount={100} />);
  ...
  it('should break down amount into chip denominations', () => {
    const { getByText } = renderWithTheme(<CashDisplay amount={500} />);
  ...
  it('should handle zero amount', () => {
    const { getByText } = renderWithTheme(<CashDisplay amount={0} />);
  ...
  it('should display chip values', () => {
    const { getByText } = renderWithTheme(<CashDisplay amount={400} />);
