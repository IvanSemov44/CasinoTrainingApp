...
describe('ExerciseStats', () => {
  describe('Score Display', () => {
    it('renders score display with correct format', () => {
      renderWithTheme(
        <ExerciseStats score={5} attempts={10} />
      );
    ...
    it('displays zero score', () => {
      renderWithTheme(
        <ExerciseStats score={0} attempts={5} />
      );
    ...
    it('displays perfect score', () => {
      renderWithTheme(
        <ExerciseStats score={10} attempts={10} />
      );
    ...
    it('displays score when score equals attempts', () => {
      renderWithTheme(
        <ExerciseStats score={7} attempts={7} />
      );
  ...
  describe('Accuracy Calculation', () => {
    ...
    it('calculates 0% accuracy for zero score', () => {
      renderWithTheme(
        <ExerciseStats score={0} attempts={10} />
      );
    ...
    it('rounds accuracy to nearest integer', () => {
      renderWithTheme(
        <ExerciseStats score={1} attempts={3} />
      );
    ...
    it('rounds up when appropriate', () => {
      renderWithTheme(
        <ExerciseStats score={2} attempts={3} />
      );
    ...
    it('handles fractional percentages correctly', () => {
      renderWithTheme(
        <ExerciseStats score={3} attempts={7} />
      );
  ...
  describe('Edge Cases', () => {
    it('handles zero attempts by displaying 0% accuracy', () => {
      renderWithTheme(
        <ExerciseStats score={0} attempts={0} />
      );
    ...
    it('displays correctly with one attempt', () => {
      renderWithTheme(
        <ExerciseStats score={1} attempts={1} />
      );
    ...
    it('displays correctly with large numbers', () => {
      renderWithTheme(
        <ExerciseStats score={500} attempts={1000} />
      );
    ...
    it('handles high accuracy with large denominators', () => {
      renderWithTheme(
        <ExerciseStats score={99} attempts={100} />
      );
  ...
  describe('Component Rendering', () => {
    it('renders both score and accuracy in same component', () => {
      renderWithTheme(
        <ExerciseStats score={8} attempts={10} />
      );
