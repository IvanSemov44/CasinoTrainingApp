...
import type { NumberPadProps, ButtonConfig } from './NumberPad.types';
...
/**
 * NumberPad component for roulette number input
 * Displays 3x3 grid of number buttons (1-9) plus Clear, 0, and Backspace
 */
const NumberPad: React.FC<NumberPadProps> = React.memo(({
  onNumberPress,
  onClear,
  onBackspace,
  disabled = false,
