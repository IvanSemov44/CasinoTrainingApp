...
describe('RacetrackTrackSvg', () => {
  describe('rendering', () => {
    it('should render without crashing', () => {
      const { root } = render(
        <RacetrackTrackSvg width={350} height={140} />
      );
    ...
    it('should render with different widths', () => {
      const { root: root1 } = render(
        <RacetrackTrackSvg width={200} height={80} />
      );
      const { root: root2 } = render(
        <RacetrackTrackSvg width={500} height={200} />
      );
    ...
    it('should render with different heights', () => {
      const { root: root1 } = render(
        <RacetrackTrackSvg width={350} height={100} />
      );
      const { root: root2 } = render(
        <RacetrackTrackSvg width={350} height={250} />
      );
      expect(root1).toBeDefined();
      expect(root2).toBeDefined();
    });
  ...
  describe('SVG structure', () => {
    it('should render Svg element with correct props', () => {
      ...
      const height = 140;
      const { root } = render(
        <RacetrackTrackSvg width={width} height={height} />
      );
      expect(root).toBeDefined();
    });
