...
describe('PLOMenuScreen', () => {
  ...
  describe('interactions', () => {
    it('should navigate to easy mode when Easy is pressed', () => {
      ...
      expect(mockNavigation.navigate).toHaveBeenCalledWith('PLOGameTraining', { difficulty: 'easy' });
    });
    ...
    it('should navigate to medium mode when Medium is pressed', () => {
      ...
      expect(mockNavigation.navigate).toHaveBeenCalledWith('PLOGameTraining', { difficulty: 'medium' });
    });
