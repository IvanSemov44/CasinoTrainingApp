...
import type { CPScenario } from '../types';
...
export default function CPDrillScreen({ route }: CPDrillScreenProps) {
  ...
  const drillState = useDrillState(generateCPScenario, drillType);
  const {
    scenario,
    phase,
    selectedOption,
...
function makeStyles(colors: ReturnType<typeof useTheme>['colors']) {
  return StyleSheet.create({
    ...
    swapBadge: { backgroundColor: '#7C3AED22', borderRadius: 6, paddingHorizontal: 8, paddingVertical: 3, alignSelf: 'flex-start', marginTop: 6, borderWidth: 1, borderColor: '#7C3AED' },
    swapBadgeText: { fontSize: 11, fontWeight: '700', color: '#7C3AED', letterSpacing: 0.5 },
